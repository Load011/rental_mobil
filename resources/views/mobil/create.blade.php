                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="plat_mobil" name="plat_mobil" value="{{old('plat_mobil')}}">
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control currency" id="harga_sewa" name="harga_sewa" value="{{ old('harga_sewa') }}" onkeyup="formatInput(this)">
                            </div>
                        </div>
                        <div class="btn-group">
